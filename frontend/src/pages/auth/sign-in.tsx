...
export function SignIn() {
  ...
  async function handleSignIn(data: SignInSchema) {
    try {
      await axios
        .get("http://localhost:7777/users", { params: data })
        .then(() => {
          reset({
            email: "",
            password: "",
  ...
  return (
    <div className="p-8">
      <picture>
        <img className="h-9/10 w-full" src="src/assets/signIn.jpg" alt="" />
      </picture>
      <section className="p-4">
        ...
        <div className="mt-4">
          ...
          <div className="mt-4 flex flex-col gap-4">
            <button className="flex h-14 items-center justify-center gap-4 rounded-lg border-1 border-blue-600 text-sm">
              <svg
                className="size-6"
                viewBox="-3 0 262 262"
        ...
        <div className="mt-10 flex flex-col gap-8">
          ...
          >
            ...
            <button
              type="submit"
              className="rounded-lg bg-stone-900 p-3 text-sm text-stone-50"
            >
              Sign In
            </button>
            <button className="rounded-lg border-1 border-blue-600 p-3 text-sm text-blue-600">
              Register Now
            </button>

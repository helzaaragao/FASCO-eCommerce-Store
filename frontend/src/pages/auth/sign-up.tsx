...
export default function SignUp(){
    ...
    return(
        <div className="p-4 lg:m-2 rounded-2xl md:items-start justify-center-safe gap-4 lg:flex ">
           <picture className="flex-1">
                <img className="lg:h-1/2" src="src/assets/signUp.jpg" alt="" />
           </picture>
           <section className="p-4 flex-1 lg:p-12">
                <h1 className="mt-4 font-volkhov text-3xl text-gray-700 lg:text-6xl lg:mb-14">FASCO</h1>
                <div className="mt-4">
                    <h2 className="font-volkhov text-xl lg:text-3xl">Create Account</h2>
                    <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:gap-20">
                        <button className="border-1 border-blue-600 rounded-lg h-14 flex items-center justify-center gap-4 text-sm lg:w-2xs lg:text-base">
                            <svg className= "size-6 lg:size-8"  viewBox="-3 0 262 262" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                ...
                <div className="mt-10 flex flex-col gap-8">
                     <div className="flex items-center justify-center gap-2">
                        ...
                        <h3 className="text-gray-500 font-bold text-center text-lg lg:text-3xl"> OR </h3>
                         <hr className="w-5 border-2 border-gray-500"/>
                    </div>
                    <form onSubmit={handleSubmit(handleSignUp)} className="lg:p-8">
